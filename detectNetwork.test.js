...
describe('Visa', function() {
  ...
  //   http://chaijs.com/
  var assert = chai.assert; // here was a FILL_ME_IN
...
describe('MasterCard', function() {
  ...
  it('has a prefix of 51 and a length of 16', function() {  // here was a FILL_ME_IN
    expect(detectNetwork('5112345678901234')).to.equal('MasterCard');
  });
 
  it('has a prefix of 52 and a length of 16', function() {  // here was a FILL_ME_IN
    expect(detectNetwork('5212345678901234')).to.equal('MasterCard');
  });
 
  it('has a prefix of 53 and a length of 16', function() { // here was a FILL_ME_IN
...
//probably could use a nested for loop but going for MVP
